...
@Component({
  selector: 'app-threejs-mouse-animation', // Assurez-vous que le sélecteur est correct
  template: '<div #threejsCanvasContainer></div>', // Remplacez ce contenu par le HTML de votre choix
})
export class ThreejsMouseAnimationComponent implements OnInit {
...
groupe.rotation.y = ratio* Math.PI * 0.3
groupe.rotation.x = ratio* Math.PI * 0.02
groupe.rotation.z = ratio* Math.PI * 0.03
